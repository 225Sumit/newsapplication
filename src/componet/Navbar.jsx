...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <NavLink className="navbar-brand" to="/s">Navbar</NavLink>
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><NavLink className="dropdown-item" to="/home">Another action</NavLink></li>
            <li><hr className="dropdown-divider"/></li>
            <li><NavLink className="dropdown-item" to="/home">Something else here</NavLink></li>
          </ul>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link disabled" to="/home" tabindex="-1" aria-disabled="true">Disabled</NavLink>
        </li>
      </ul>
